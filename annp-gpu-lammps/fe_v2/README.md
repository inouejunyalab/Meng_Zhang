## This is new GPU implementation for ANNP of Fe, which has a 10% speedup increasing than the previous one. You can compile this into LAMMPS [1] according to the procedures in "fe" file.
