## This is new GPU implementation for ANNP of Fe [1-2], which has a 12-14% speedup increasing than the previous one. You can compile this into LAMMPS [3] according to the procedures in "fe" file.
