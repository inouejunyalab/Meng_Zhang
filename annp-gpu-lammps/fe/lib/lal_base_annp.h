...
public:
	...
	int bytes_per_atom_annp(const int max_nbors) const;												

	// Total host memory used by library for pair style
	double host_memory_usage_annp() const;															
	...
	void compute(const int ago, const int inum, const int nall,										
	...
	int** compute(const int ago, const int inum, const int nall,									
				  double** host_x, int* host_type, double* sublo,
				  double* subhi, tagint* tag, int** nspecial,
	...
	inline void set_kernel_annp(const int eflag) {													
#if defined (LAL_OCL_EV_JIT)																		 
		if (eflag)
			k_pair_sel = &k_pair;																	
		else
