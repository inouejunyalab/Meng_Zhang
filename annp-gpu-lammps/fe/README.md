...
-All the potential parameters (Fe) are obtained from Dr. H. Mori and co-workers [1], but the format is defined by us, as can be see the "fe_annp_potential_2.ann" file. 
