...
-All the potential parameters (Ni) are obtained from Dr. S. Desai, Dr. S.T. Reeve and co-workers (References 3 and 4), but the format is defined by us, as can be see the "ni_annp_potential_2.ann" file. 
...
3) S. Desai, S.T. Reeve, J.F. Belak, Comput. Phys. Commun. 270 (2022).
4) J. Behler, M. Parrinello, Phys Rev Lett. 98 (2007).
