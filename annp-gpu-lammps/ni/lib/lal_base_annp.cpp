...
BaseAnnpT::BaseAnnp() : _compiled(false), _max_bytes(0), _onetype(0) {								
...
template <class numtyp, class acctyp>
int BaseAnnpT::init_annp(const int nlocal, const int nall, const int max_nbors,							
	...
	compile_kernels(*ucl_device, pair_program, k_name, k_updat, k_short_nbor, onetype);				
...
----------------------------------------------------------------------*/
template <class numtyp, class acctyp>
void BaseAnnpT::compile_kernels(UCL_Device& dev, const void* pair_str,							
