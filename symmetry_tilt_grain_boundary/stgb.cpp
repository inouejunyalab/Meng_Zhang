...
int main() {
    ...
    double matrix0_xyz[3][3] = { -1,1,-2, 1, -1, -1,  1, 1, 0 };
    double length_box[3] = { 34.97014031, 49.45524671, 32.30403188 };
    double rot_angle0[3] = { 0.0, 0.0, 0.0 };                      // negative, anticlockwise
    ...
    matrix0.rot_xyz(rot_angle0);									// rotate the box vector for grain 1	
